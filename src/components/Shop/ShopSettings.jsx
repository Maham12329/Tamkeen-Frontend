...
const ShopSettings = () => {
    ...
    const [area, setArea] = useState(seller?.area || "");
...
<div className="w-full pb-3">
  <label className="block pb-2 text-[#5a4336]">Shop Region</label>
  <input
    type="text"
    className={girlyStyles.input}
    required
    value={region}  // Add region state
    onChange={(e) => setRegion(e.target.value)}
  />
</div>
<div className="w-full pb-3">
  <label className="block pb-2 text-[#5a4336]">Shop Area</label>
  <input
    type="text"
    className={girlyStyles.input}
    required
    value={area}  // Add area state
